...
class ProjectController extends Controller
{
    ...
    public function taskCreate($slug, $projectID)
    {
        ...
        {
            $project  = Project::select('projects.*')->where('created_by', '=', $objUser->id)->where('projects.workspace', '=', $currentWorkspace->id)->where('projects.id', '=', $projectID)->first();
            $projects = Project::select('projects.*')->where('created_by', '=', $objUser->id)->where('projects.workspace', '=', $currentWorkspace->id)->get();
        }
    ...
    public function bugReportCreate($slug, $project_id)
    {
        ...
        {
            $project = Project::where('created_by', '=', $objUser->id)->where('projects.workspace', '=', $currentWorkspace->id)->where('projects.id', '=', $project_id)->first();
        }
