            ...
            <div class="row">
                <div class="col-12">
                    @if(empty(env('PUSHER_APP_ID')) || empty(env('PUSHER_APP_KEY')) || empty(env('PUSHER_APP_SECRET')) || empty(env('PUSHER_APP_CLUSTER')))
                        <div class="alert alert-warning"><i class="fas fa-warning"></i> {{ __('Please Add Pusher Detail in Setting Page ') }}<u><a href="{{ route('settings.index') }}">{{ __('here')}}</a></u></div>
                    @endif
                    @if(empty(env('MAIL_DRIVER')) || empty(env('MAIL_HOST')) || empty(env('MAIL_PORT')) || empty(env('MAIL_USERNAME'))  || empty(env('MAIL_PASSWORD'))  || empty(env('MAIL_PASSWORD')))
                        <div class="alert alert-warning"><i class="fas fa-warning"></i> {{ __('Please Add Mail Details in Setting Page ') }} <u><a href="{{ route('settings.index') }}">{{ __('here')}}</a></u></div>
                    @endif
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="card card-box">
                        <div class="left-card">
                            ...
                            <h4>{{ __('Total') }} <span>{{ $totalUsers }} {{ __('Users') }}</span></h4>
                        </div>
                        <div class="mt-2">
                            <small class="font-weight-bold">{{ $totalPaidUsers }}</small> <small>{{ __('Paid Users') }}</small>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="card card-box">
                        <div class="left-card">
                            ...
                            <h4>{{ __('Total') }} <span>{{ $totalUsers }} {{ __('Orders') }}</span></h4>
                        </div>
                        <div class="mt-2">
                            <small class="font-weight-bold">{{ (env('CURRENCY_SYMBOL') != '' ? env('CURRENCY_SYMBOL') : '$') . $totalOrderAmount }}</small> <small>{{ __('Order Amount') }}</small>
                        </div>
                    </div>
                    <img src="{{ asset('assets/img/dot-icon.png') }}" class="dotted-icon">
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4">
                    <div class="card card-box">
                        <div class="left-card">
                            ...
                            <h4>{{ __('Total') }} <span>{{ $totalPlans }} {{ __('Plans') }}</span></h4>
                        </div>
                        <div class="mt-2">
                            <small class="font-weight-bold">@if($mostPlans) {{$mostPlans->name}} @else - @endif</small> <small>{{ __('Most purchase plan') }}</small>
                        </div>
                    </div>
                    <img src="{{ asset('assets/img/dot-icon.png') }}" class="dotted-icon">
                </div>
                ...
                <div class="col-12">
                    <div class="card animated">
                        <div class="card-header">
                            <h6 class="float-left">
                                {{ __('Recent Orders') }}
                                <small class="d-block mt-2">{{ __('Last Week Orders') }}</small>
                            </h6>
                        </div>
                        <div class="card-body">
