    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="form-icon-user">
                ...
                <input class="form-control" type="number" min="0" id="monthly_price" name="monthly_price" value="{{ $plan->monthly_price }}" placeholder="{{ __('Enter Monthly Price') }}">
            </div>
        </div>
        <div class="form-group col-md-6">
            ...
            <div class="form-icon-user">
                <span class="currency-icon">{{ (env('CURRENCY_SYMBOL') ? env('CURRENCY_SYMBOL') : '$') }}</span>
                <input class="form-control" type="number" min="0" id="annual_price" name="annual_price" value="{{ $plan->annual_price }}" placeholder="{{ __('Enter Monthly Price') }}">
            </div>
        </div>
        <div class="form-group col-md-6">
