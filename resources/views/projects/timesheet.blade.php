...
@section('multiple-action-button')
    ...
    @if($project_id != '-1')
        <div class="col-md-2">
            @auth('client')
                <a href="{{route('client.projects.show',[$currentWorkspace->slug,$project_id])}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                    <i class="fa fa-reply"></i> {{ __('Back') }}
                </a>
            @elseauth
                <a href="{{route('projects.show',[$currentWorkspace->slug,$project_id])}}" class="btn btn-xs btn-white btn-icon-only width-auto">
                    <i class="fa fa-reply"></i> {{ __('Back') }}
                </a>
            @endauth
        </div>
